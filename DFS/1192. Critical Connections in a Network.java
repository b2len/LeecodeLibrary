class Solution {
    /**
     * Basically, it uses dfs to travel through the graph to find if current vertex
     * u, can travel back to u or previous vertex
     * low[u] records the lowest vertex u can reach disc[u] records the time when u
     * was discovered
     */
