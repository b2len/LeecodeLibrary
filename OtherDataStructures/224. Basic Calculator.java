class Solution {
     ...
     * One important thing is that the input is valid, which means the parentheses
     * are always paired and in order.
     ...
     * this pair of parenthesis,
     * second is the temporary result before this pair of parenthesis. We add them
     * together.
    ...
    public int calculate(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            char c = s.charAt(i);
            // handel nums with multiple digits
